    ...
    document.getElementById("startButton").addEventListener("click", function () {
        ...
        btnContinue.addEventListener("click", function () {
            content.innerHTML = `
                ...
                <div class="question">
                    <p style="font-size: 24px;">Quieres Ser Mi San Valentin?</p>
            ...
            document.getElementById("yesBtn").addEventListener("click", function () {
                content.innerHTML = `
					<div style="text-align: center;">
						...
						<p style="font-size: 24px;"> Sabia Que dirias que si</p>
					</div>
				
                    <div style="text-align: center; margin-top: 50px;">
                        <button id="surpriseBtn" style="padding: 12px 25px; font-size: 18px; background: #ffa500; color: white; border: none; cursor: pointer; border-radius: 5px;"> haz clic para la sorpresa
</button>
                    </div>
                `;
                ...
                document.getElementById("surpriseBtn").addEventListener("click", function () {
                    content.innerHTML = `
						<div style="text-align: center; margin-top: 20px;">
							...
							<br>
							<a id="downloadBtn" href="pictures/itinerary.png" download style="display: inline-block; padding: 12px 25px; background: #FF6863; color: white; border-radius: 5px; text-decoration: none; font-size: 18px; font-weight: bold; transition: 0.3s;">Descarga La carta</a>
						</div>
					`;
                });
            });
